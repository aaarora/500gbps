...
python3 main.py --source=10.0.11.100:2094  --destination=10.0.11.6:2096  --numStreams=1 --numBatches=1 --start=500 --stop=1000 & # Caltech --> UCSD-02 3811
python3 main.py --source=10.0.12.100:2095  --destination=10.0.12.6:2097  --numStreams=1 --numBatches=1 --start=500 --stop=1000 & # Caltech --> UCSD-02 3812
